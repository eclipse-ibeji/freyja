...
const IBEJI_INTERFACES_BASE_URI: &str = "https://raw.githubusercontent.com/eclipse-ibeji/ibeji/main/interfaces";

fn main() -> Result<(), Box<dyn std::error::Error>> {
    compile_remote_proto(
        format!("{IBEJI_INTERFACES_BASE_URI}/invehicle_digital_twin/v1/invehicle_digital_twin.proto"),
        &[
