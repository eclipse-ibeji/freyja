...
- [The `in-memory-with-fn` example](../../freyja/examples/in-memory-with-fn.rs) demonstrates a more complex scenario that performs manual setup and invokes the `freyja_main` function directly.
